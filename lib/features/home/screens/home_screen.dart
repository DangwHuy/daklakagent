...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Trợ Lý Sầu Riêng Pro v2.0"),
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            // === WIDGET CẢI TIẾN: CHÚC BÀ CON ĐĂK LĂK ===
            Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [Colors.green[50]!, Colors.white], // Gradient xanh lá nhạt đến trắng
                    begin: Alignment.topLeft,
                    end: Alignment.bottomRight,
                  ),
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Icon(Icons.favorite, color: Colors.red[600], size: 28), // Icon trái tim lớn hơn
                    ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Gửi chút nắng ấm từ phương xa về với Đăk Lăk yêu thương. Xin được san sẻ những khó khăn, mất mát mà bà con đang phải gánh chịu. Mong mọi người hãy thật vững tâm, giữ gìn sức khỏe. Cầu chúc bình an đến với từng nếp nhà, bão lũ rồi sẽ tan, ngày mai trời lại sáng!💪",
                            style: TextStyle(
                              fontSize: 14,
            ...
            // 👇 WIDGET CHÍNH - PHÂN TÍCH THÔNG MINH
            const ProWeatherCardV2(),
...
// ==========================================
// WIDGET HIỂN THỊ PHÂN TÍCH THÔNG MINH V2
// ==========================================
class ProWeatherCardV2 extends StatefulWidget {
  const ProWeatherCardV2({super.key});

  @override
  State<ProWeatherCardV2> createState() => _ProWeatherCardV2State();
}

class _ProWeatherCardV2State extends State<ProWeatherCardV2> {
  late Future<Map<String, dynamic>> _dataFuture;

  // ⚠️ THAY LINK NGROK MỚI TẠI ĐÂY
      ...
      builder: (context, snapshot) {
          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                const Text("Đang phân tích thông minh...",
          ...
          return Container(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 12),
                const Text(
                  "Mất kết nối với Bộ Não AI",
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
                ),
                const SizedBox(height: 8),
                Text(
                  "Kiểm tra Google Colab hoặc Link Ngrok",
        ...
        return Column(
          ...
          children: [
            ...
            // Danh sách khu vực (Scroll ngang)
            SizedBox(
              height: 520,
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return _buildSmartCard(listData[index]);
                },
              ),
            ),
          ],
  ...
  Widget _buildSmartCard(dynamic item) {
  ...
  // Widget hiển thị chỉ số nguy cơ
  Widget _buildRiskIndicator(String label, int value, IconData icon, Color color) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: bgColor[50],
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: bgColor[200]!),
      ),
      child: Column(
        children: [
          Row(
            ...
            children: [
              Icon(icon, size: 16, color: bgColor[700]),
              const SizedBox(width: 4),
              Text(
                label,
                style: TextStyle(fontSize: 11, color: bgColor[900]),
              ),
            ],
          ),
          const SizedBox(height: 4),
  ...
  Widget _buildAlertCard(dynamic cb) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border(
          left: BorderSide(
            color: _getIconColor(cb['icon'] ?? 'info'),
            width: 4,
          ),
        ),
      ),
      ...
      child: Column(
        ...
        children: [
          ...
          if (keHoach['uu_tien_cao'] != null && (keHoach['uu_tien_cao'] as List).isNotEmpty) ...[
            _buildPrioritySection("🔴 Ưu tiên cao (Hôm nay)", keHoach['uu_tien_cao'], Colors.red),
          ],
  ...
  Color _getIconColor(String iconName) {
    ...
    if (iconName == 'warning' || iconName == 'sunny' || iconName == 'local_fire_department') {
      return Colors.red;
    }
